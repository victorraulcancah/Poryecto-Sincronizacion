// src/app/component/categoria-modal/categoria-modal.component.ts
import { Component, Input, Output, EventEmitter, OnInit, OnChanges } from '@angular/core';
import { CommonModule } from '@angular/common';
import { ReactiveFormsModule, FormBuilder, FormGroup, Validators } from '@angular/forms';
import { CategoriasService, Categoria, CategoriaCreate } from '../../services/categorias.service';
  ...
  onSubmit(): void {
    if (this.categoriaForm.valid) {
      ...
      const request = this.categoria 
        ? this.categoriasService.actualizarCategoria(this.categoria.id, categoriaData)
