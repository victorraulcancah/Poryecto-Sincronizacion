...
<body>
    ...
    <div class="content">
        ...
        <p>Adjunto encontrará su Nota de Crédito electrónica en formato PDF y XML.</p>

        <div class="info-box">
            <h3 style="margin-top: 0; color: #FF9800;">Información de la Nota de Crédito</h3>
            ...
            <div class="info-row" style="font-size: 18px; font-weight: bold; color: #FF9800;">
        ...
        <div style="background-color: #d4edda; border-left: 4px solid #28a745; padding: 12px; margin: 15px 0;">
            <strong style="color: #155724;">✓ Nota de Crédito aceptada por SUNAT</strong>
        </div>
        @endif
        ...
        <p style="margin-top: 20px;">Si tiene alguna consulta sobre esta nota de crédito, no dude en contactarnos.</p>
