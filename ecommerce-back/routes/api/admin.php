...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/contacto/mensajes/exportar', [\App\Http\Controllers\ContactoController::class, 'exportar']);
    ...
    Route::middleware('permission:empresa_info.edit')->group(function () {
        ...
        Route::put('/empresa-info/{id}/descripcion', [EmpresaInfoController::class, 'actualizarDescripcion']);
